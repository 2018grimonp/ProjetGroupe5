...
def creation_string(code):
    ...
    graph="Fonction copiées-donne le nombre de fonctions suceptible d'e^tre fraudé (avec une précision minimale de "+str(precision)+"% -fonction originale+fonctions copiées-"+str(100-copies_percent)+"-Multiplicateur de note: "+str(1-copies_percent/100)+" pourcentage de duplication :"+str(donnees[2])+"%-|"
    return (graph)
