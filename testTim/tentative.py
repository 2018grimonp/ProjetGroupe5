...
CodeTest1=readLines("test.rb")

CodeControle1=readLines("testControle.rb")



print(duplicationFonction.controle_duplication(CodeTest1,60,CodeControle1))
print(duplicationFonction.retuour_resresultats_similitude(CodeTest1,60,CodeControle1))
